...
function DisplayCourse() {
  ...
  const HandleSearch = () => {
    const newData = courses.filter(x => x.school === school).filter(y => y.year <= year).filter(z => z.sem === sem);
  ...
  return (
    ...
    <form action="post">
                      ...
                      <table className="min-w-full text-center sm:text-sm">
                        <tbody>
                          <tr>
                            ...
                            <select className='border w-32' value={school} onChange={ (e)=>setSchool(e.target.value)} required>
                            ...
                            <select className='border w-32' value={year} onChange={ (e)=>setYear(e.target.value)}  required>
                            <option value="">-SELECT-</option>
                            ...
                            <td className="text-lg text-gray-900 font-light px-6 py-4 whitespace-nowrap ">
                            <select className='border w-32' value={sem} onChange={ (e)=>setSem(e.target.value)}  required>
                            <option value="">-SELECT-</option>
                            ...
                            <td className="text-lg text-gray-900 font-light px-6 py-4 whitespace-nowrap ">
                            <select className='border w-32'  value={course} onChange={ (e)=>setCourse(e.target.value)} required>
                            <option value="">-SELECT-</option>
                    ...
                    <div className="text-lg text-black px-6 py-6 whitespace-nowrap flex flex-col justify-center items-center">
                      ...
                      <button className="bg-[#0083CA] text-white font-bold ml-8 py-1.5 px-6 rounded-md" onClick={() => HandleSearch()} >Display</button>
                      </div>
